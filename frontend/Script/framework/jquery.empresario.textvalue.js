function CreateTextValue(parameters) {
    var retorno = "";
    var readonlybool = "";
    ...
    if (symbol != "") {
        ...
        retorno = retorno + "<span class='input-group-addon'><i class='" + symbol + "'></i></span>";
        final = "</div>"
    }
    ...
    //retorno =  retorno + "<span class='input-group-addon'>.00</span>";
