function CreateControlNumber(parameters) {
    var retorno = "";
    var readonlybool = "";
   ...
   // retorno = "<div class='form-group " + classe + " " + tamanho + "'>"
    ...
    if (value != null && value != "" && value != undefined) {
        //valorFinal = ConvertToNumberFixed(value);
        //$("#" + id).val(valorFinal).keyup();
    } else {
        //valorFinal = ConvertToNumberFixed(defaultValue);
        //$("#" + id).val(valorFinal).keyup();
    }
}