...
function atualizaDadosHtmlMongoDB(tabGenID, layoutID) {
    ...
    //pega o select all
    var _listall = "";
    var urllistall="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getSelectListAll/" + enterpriseID + "/" + layoutID;
    $.ajax({
        method: "GET",
        async: false,
        url: urllistall
    ...
    var _finddata = "";
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getSelecFinddata/" + enterpriseID + "/" + layoutID;
    $.ajax({
        method: "GET",
        async: false,
        url: urldata
    ...
    $.ajax({
        method: "POST",
        url: "http://" + getGlobalParameters("urlPlataform") + ":3001/api/saveHtml",
    ...
    var _finddata = "";
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getListContainersLayout/" + enterpriseID + "/" + layoutID;
    $.ajax({
        method: "GET",
        async: false,
        url: urldata
    ...
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getSelecFindFillGrid/";
    $.ajax({
    ...
    _finddata = JSON.stringify(_finddata)
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getSelecFindDataGrid/";
    $.ajax({
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        method: "POST",
        async: false,
   ...
   _finddata = JSON.stringify(_finddata)
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getDeleteData/";
    $.ajax({
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        method: "POST",
        async: false,
    ...
    _finddata = JSON.stringify(_finddata)
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/saveCollectionContainers/";
    $.ajax({
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        method: "POST",
        async: false,
    ...
    var _finddata = "";
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/getSelecControls/" + enterpriseID + "/" + layoutID;
    $.ajax({
        method: "GET",
        async: false,
        url: urldata
    ...
    _finddata = JSON.stringify(_finddata)
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/saveCollectionControls/";
    $.ajax({
        headers: { "Content-Type": "application/json", "Accept": "application/json" },
        method: "POST",
        async: false,
...
function atualizaDadosHtmlMongoDB2(tabGenID, layoutID) {
    ...
    $.ajax({
        method: "POST",
        url: "http://" + getGlobalParameters("urlPlataform") + ":3001/api/saveLayout",
        async: false,
    ...
    var urldata="http://" + getGlobalParameters("urlPlataform") + ":3001/api/saveContainers/" + enterpriseID + "/" + layoutID;
    $.ajax({
        method: "GET",
        async: false,
        url: urldata
