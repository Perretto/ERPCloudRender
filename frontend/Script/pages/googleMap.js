...
function direction_go_map(){
    ...
    $("#direction").goMap({
        ...
        icon: 'Images/icons/office-i-32.png',
        addMarker: 'single',
...
function find_location_go_map(){
    ...
    $("#findLocation").goMap({
        ...
        icon: 'Images/icons/gmapsingle-i-32.png',
        addMarker: 'single',
        disableDoubleClickZoom: true,
        zoom: 14
    });
...
function branch_locator_go_map(){
    ...
    var $branch = $("#branch").goMap({
        ...
        markers: [{
            ...
            title: 'Home',
            icon: 'Images/icons/home-i-32.png'
        },{
            address:"sydney, australia",
            draggable: false,
            icon: 'Images/icons/shop-i-32.png',
            html: {
                content: 'Show Room',
                popup:false
            }
            ...
            address:"Peru",
            draggable: true,
            icon: 'Images/icons/factory-i-32.png',
            html: {
                content: 'Industry',
                popup:false
            }
